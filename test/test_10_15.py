...
base_path = '../../2020_10_15_test/'
movie_path = '../../2020_10_15_test/test.mp4'

media.movie2frames(movie_path, base_path + 'frames/', 'img')

mask.make_detail_mask(base_path + 'frames/', base_path + 'd_mask.jpg', frame_num=250)
...
for index, img_path in enumerate(sorted(glob.glob('../../2020_10_15_test/frames/*.jpg'))):
    if index < 50 or index > 100:
        continue
    result = inpainting.get_homography_frames(img_path, index, '../../2020_10_15_test/frames/', '../../2020_10_15_test/r_mask.jpg')
    target = cv2.imread(img_path)
    mask = cv2.imread('../../2020_10_15_test/r_mask.jpg')
    img = inpainting.inpaint_target_ave_neer(target, result, mask)
    cv2.imwrite('../../2020_10_15_test/result/img' + str(index) + '.jpg', img)