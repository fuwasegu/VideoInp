...
base_path = '../../2020_11_02_test/'
movie_path = '../../2020_11_02_test/test.mp4'
...
for index, img_path in enumerate(sorted(glob.glob('../../2020_11_02_test/frames/*.jpg'))):
    if index < 100 or index > 400:
        continue
    result = inpainting.get_homography_frames(img_path, index, '../../2020_11_02_test/frames/', '../../2020_11_02_test/r_mask.jpg')
    target = cv2.imread(img_path)
    mask = cv2.imread('../../2020_11_02_test/r_mask.jpg')
    img = inpainting.inpaint_target_ave_neer(target, result, mask)
    cv2.imwrite('../../2020_11_02_test/result/img' + str(index) + '.jpg', img)